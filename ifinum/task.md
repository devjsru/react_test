...
Использовать [db.json link]("https://github.com/devjsru/react_test/blob/master/ifinum/db.json") (лежит по соседству с этим файлом) для https://github.com/typicode/json-server
